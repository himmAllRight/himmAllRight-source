...
### Getting Started
<img alt="Linux from Scratch Logo" src="../../img/posts/LFS-intro/book-cover.jpg" width= 100%>
...
<img alt="VM installation Complete" src="../../img/posts/LFS-intro/VM-install.png" width=100%>
...
<center><img alt="Adding LFS hd" src="../../img/posts/LFS-intro/HD-add.png"></center>
...
<img alt="Adding LFS hd" src="../../img/posts/LFS-intro/environment-check-pre.png" width=100%>
...
<img alt="Adding LFS hd" src="../../img/posts/LFS-intro/environment-check-post.png" width=100%>

After installing those few packages and fixing the symlink, the check script was happy, and I could move on.


#### Checking Libraries
<img alt="Adding LFS hd" src="../../img/posts/LFS-intro/library-check.png">
...
<img alt="Adding LFS hd" src="../../img/posts/LFS-intro/disks.png">

I first used `lsblk` to confirm the disk name. In my case it was the `/dev/sdb` disk.

<img alt="Adding LFS hd" src="../../img/posts/LFS-intro/mkfs.png">
